...
public class EmployeeRepositoryImpl implements EmployeeRepository {
	...
	public List<Employee> findCoworkers(Employee employee) {
		return  //
		//
		entityManager.createQuery("SELECT u from User u where u.manager = :manager").setParameter("manager", employee.getManager()).getResultList();
	}
	...
	public List<Employee> findSubordinates(Employee manager) {
		return  //
		//
		entityManager.createQuery("SELECT u from User u where u.manager = :manager").setParameter("manager", manager).getResultList();
	}

	@SuppressWarnings("all")
	public EmployeeRepositoryImpl(@NonNull final EntityManager entityManager) {
