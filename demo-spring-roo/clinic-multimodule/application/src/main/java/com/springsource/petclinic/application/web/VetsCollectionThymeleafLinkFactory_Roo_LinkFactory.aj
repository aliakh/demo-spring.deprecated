...
import com.springsource.petclinic.application.web.VetsCollectionThymeleafLinkFactory;
...
privileged aspect VetsCollectionThymeleafLinkFactory_Roo_LinkFactory {
     ...
     * 
     */
    public static final String VetsCollectionThymeleafLinkFactory.DATATABLESBYIDSIN = "datatablesByIdsIn";
