...
privileged aspect CategoriesItemThymeleafController_Roo_Thymeleaf {
    ...
    public Integer CategoriesItemThymeleafController.getLastVersion(Category record) {
        Long versionValue = getCategoryService().findOne(record.getId()).getVersion();
    ...
    public ModelAndView CategoriesItemThymeleafController.update(@Valid @ModelAttribute Category category, BindingResult result, @RequestParam("version") Long version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, Model model) {
