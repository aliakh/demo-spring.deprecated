...
privileged aspect SuppliersItemThymeleafController_Roo_Thymeleaf {
    ...
    public Integer SuppliersItemThymeleafController.getLastVersion(Supplier record) {
        Long versionValue = getSupplierService().findOne(record.getId()).getVersion();
    ...
    public ModelAndView SuppliersItemThymeleafController.update(@Valid @ModelAttribute Supplier supplier, BindingResult result, @RequestParam("version") Long version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, Model model) {
