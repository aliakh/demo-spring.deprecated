...
import org.springframework.roo.northwind.web.ShippersSearchThymeleafController;
...
privileged aspect ShippersSearchThymeleafController_Roo_Thymeleaf {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<ShipperProjection>> ShippersSearchThymeleafController.byPhoneDt(@ModelAttribute("formBean") ShipperPhoneFormBean formBean, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam(Datatables.PARAMETER_DRAW) Integer draw) {
        ...
        ConvertedDatatablesData<ShipperProjection> datatablesData = new ConvertedDatatablesData<ShipperProjection>(shippers, totalShippersCount, draw, getConversionService(), datatablesColumns);
