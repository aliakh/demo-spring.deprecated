...
privileged aspect ProductsItemThymeleafController_Roo_Thymeleaf {
    ...
    public Integer ProductsItemThymeleafController.getLastVersion(Product record) {
        Long versionValue = getProductService().findOne(record.getId()).getVersion();
    ...
    public ModelAndView ProductsItemThymeleafController.update(@Valid @ModelAttribute Product product, BindingResult result, @RequestParam("version") Long version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, Model model) {
